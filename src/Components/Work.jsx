        ...
        <>
            ...
            PandoraFridge is a Work-In-Progress T3 Stack <span className='text-black italic '> (Next.js, Typescript, tRPC) </span> app that allows user to log in via Discord and add foods in a fridge with timer.
                            ...
                            <div className='flex flex-col gap-2 mt-4'>
                                <button onClick={redirectToPandoraF} data-aos='fade-right' data-aos-delay='700'  className='inline-flex w-[160px] items-center justify-center px-8 py-2 text-base font-medium text-center text-white border border-black bg-black  hover:bg-[#000B3A] focus:ring-4 focus:ring-gray-10'>View Project</button>
