                    ...
                    <div className=' lg:w-[350px]'>
                        ...
                        <div className="flex flex-col gap-4 justify-center mt-8">
                            ...
                            <div className='flex flex-col gap-2 mt-4'>
                                <button data-aos='fade-right' data-aos-delay='700'  className='inline-flex w-[160px] items-center justify-center px-8 py-2 text-base font-medium text-center text-white border border-black bg-black  hover:bg-[#000B3A] focus:ring-4 focus:ring-gray-10'>View Project</button>
                                <span data-aos='fade-right' data-aos-delay='700' className='underline tracking-4 hover:cursor-pointer'>
                                    View All Projects
                                </span>
                            </div>
                        </div>
