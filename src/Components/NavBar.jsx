  ...
  <div class="container flex flex-wrap items-center justify-between mx-auto max-w-[1400px]">
    ...
    <div class="hidden  w-full md:block md:w-auto" id="navbar-default">
      <ul class="flex  flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="/work" class="block py-2 pl-3 pr-4 text-gray-700 text-base  rounded font-semibold font-Barlow md:bg-transparent md:text-gray-700 md:hover:text-blue-700 md:p-0 dark:text-white" aria-current="page">Work</a>
        </li>
        <li>
